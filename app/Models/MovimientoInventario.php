...
class MovimientoInventario extends Model
{
    ...
    public function getTipoColorAttribute(): string
    {
        return match($this->tipo) {
            'entrada_compra', 'devolucion_venta', 'ajuste_positivo', 'inventario_inicial', 'traslado_entrada' => 'success',
            'salida_venta', 'devolucion_compra', 'ajuste_negativo', 'traslado_salida', 'merma' => 'danger',
            default => 'gray',
        };
    }
    ...
    public function getEsEntradaAttribute(): bool
    {
        return in_array($this->tipo, [
            'entrada_compra', 'devolucion_venta', 'ajuste_positivo', 'inventario_inicial', 'traslado_entrada'
        ]);
    }
